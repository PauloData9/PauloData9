...
### 🎮 PS4 vs Xbox One — Global Game Sales Dashboard (Excel)

Dashboard analítico desenvolvido em Microsoft Excel para comparar o desempenho de vendas globais entre PlayStation 4 e Xbox One por região, gênero, ano de lançamento, publishers e jogos.

🔗 https://github.com/PauloData9/ps4-vs-xbox-dashboard

---

### 🤖 ETL Habit Insights Pipeline (Python)

Pipeline ETL desenvolvido em Python integrando CSV, API REST e Inteligência Artificial Generativa para enriquecimento automático de dados e atualização dos registros na API.

🔗 https://github.com/PauloData9/etl-habit-insights-pipeline
...
https://www.linkedin.com/in/paulo-ricardo-costa-mariano-de-souza-834585376

📧 E-mail

paulorcms99@gmail.com
